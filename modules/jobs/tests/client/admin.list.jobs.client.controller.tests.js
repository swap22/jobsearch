(function () {
  ...
  describe('Admin Jobs List Controller Tests', function () {
    // Initialize global variables
    var JobsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _JobsService_) {
      ...
      $httpBackend.whenGET('/modules/jobs/client/views/list-jobs.client.view.html').respond(200, '');
      ...
      JobsAdminListController = $controller('JobsAdminListController as vm', {
        $scope: $scope
      });
